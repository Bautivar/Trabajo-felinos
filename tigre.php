...
<main id="main">
    ...
    <section id="caracteristicas" class="container-fluid text-center">
        ...
        <div class="row m-0">
            <div class="col-md-4 py-4">
                <img src="img/iconos/camuflaje.png" class="img-fluid mb-4" alt="Icono de multitud de personas">
            ...
            <div class="col-md-4 py-4">
                <img src="img/iconos/huella.png" class="img-fluid mb-4" alt="Icono leon">
                <p>El tigre de Bengala caza en solitario, usando su sigilo, fuerza y agudeza visual para sorprender a sus presas.<p>
            </div>
            <div class="col-md-4 py-4">
                <img src="img/iconos/agua.png" class="img-fluid mb-4" alt="Icono rugido">
    ...
    <section id="habitatAlimentacion" class="container text-center">
        ...
        <div class="row py-4 justify-content-around">
            ...
            <div class="col-md-3">
                <img src="img/tigre/axis.jpg" class="img-fluid" alt="Impala">
                <h4>Ciervo axis</h4>
            </div>
            <div class="col-md-3">
                <img src="img/tigre/jabali.jpg" class="img-fluid" alt="Cebra">
                <h4>Jabali</h4>
            </div>
            <div class="col-md-3">
                <img src="img/tigre/jaga.webp" class="img-fluid" alt="Búfalo">
                <h4>Jaguar</h4>
            </div>
            <div class="col-md-3">
                <img src="img/tigre/mono.jpg" class="img-fluid" alt="Jabali">
                <h4>Mono</h4>
            </div>
        </div>
    </section>
